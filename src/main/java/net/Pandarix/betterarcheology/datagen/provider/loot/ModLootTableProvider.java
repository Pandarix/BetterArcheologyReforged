...
public class ModLootTableProvider implements LootTableSubProvider
{
    ...
    protected static final ResourceLocation SUPPLY_LOOTTABLE_ID = new ResourceLocation(BetterArcheology.MOD_ID, "blocks/supply_loot_from_loot_vase");
    protected static final ResourceLocation TREASURE_LOOTTABLE_ID = new ResourceLocation(BetterArcheology.MOD_ID, "blocks/treasure_loot_from_loot_vase");
    protected static final ResourceLocation GREEN_TREASURE_LOOTTABLE_ID = new ResourceLocation(BetterArcheology.MOD_ID, "blocks/treasure_loot_from_green_loot_vase");
    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> pOutput)
    {
        ...
        pOutput.accept(SUPPLY_LOOTTABLE_ID, LootTable.lootTable()
        ...
        //NORMAL
        pOutput.accept(TREASURE_LOOTTABLE_ID, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2, 3))
        ...
        //GREEN
        pOutput.accept(GREEN_TREASURE_LOOTTABLE_ID, LootTable.lootTable()
